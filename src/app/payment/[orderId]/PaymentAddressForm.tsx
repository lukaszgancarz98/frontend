    ...
    <div className="w-full">
      <div className="flex flex-col">
        <form onSubmit={saveAddresData} className="my-5">
          <div className="text-2xl font-semibold mx-5 mb-5">Przesyłka</div>
          ...
          <div className="relative border-y-2 my-5 py-5 px-5">
            <div className="text-2xl font-semibold">Adres rachunku</div>
            <div>
              Adres do rachunku jest {editAddress ? "inny niż" : "taki sam jak"}{" "}
              adres do dostawy
            </div>
            <div
            ...
            {editAddress && (
              <div className="flex flex-col gap-6 py-3">
                <div className="flex flex-row gap-5 mx-5">
                  ...
                  <div className="grid gap-3 w-full">
                    <Label htmlFor="surnameAdd">Nazwisko*</Label>
                    <Input
                      id="surnameAdd"
                      type="text"
                      name="surnameAdd"
                      required={editAddress}
                      value={additionalPaymentInfo?.surname}
                    />
                  </div>
                </div>
                <div className="flex flex-row mx-5 gap-5">
                ...
                <div className="grid gap-3 mx-5">
                  ...
                  <Input
                    ...
                    value={additionalPaymentInfo?.additionalAddresInfo}
                  />
                </div>
                <div className="grid gap-3 mx-5">
                ...
                <div className="flex flex-row mx-5 gap-5">
                  <div className="grid gap-3 w-full">
                    <Label htmlFor="postalCodeAdd">Kod pocztowy*</Label>
                    <Input
                      id="postalCodeAdd"
                      type="text"
                      name="postalCodeAdd"
                      required={editAddress}
                      value={additionalPaymentInfo?.postalCode}
                    />
                  </div>
                  <div className="grid gap-3 w-full">
                    <Label htmlFor="cityAdd">Miejscowość*</Label>
                    <Input
                      id="cityAdd"
                      type="text"
                      name="cityAdd"
          ...
          <div className="relativemy-5 px-5 pb-5">
            <div className="text-2xl font-semibold pb-4">Rodzaj przesyłki</div>
                ...
                deliverTypes.map((type) => (
                  ...
                  >
                    ...
                    <div className="text-sm pl-1">
                      {returnDeliverDates(type.deliverTime)}
                    </div>
                    <div className="absolute top-0 right-0 font-bold text-lg pt-2 pr-2">
                      {type.price.toFixed(2).replace(".", ",")} zł
                    </div>
                  </div>
                ))}
            </div>
